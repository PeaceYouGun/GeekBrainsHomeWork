...
////
        try {
            FileOutputStream fileOutputStreamMain = new FileOutputStream("text.txt");
...
//            byte[] myString = "Hello_world! Java!".getBytes();
            String string = "This is main thread 123";
            printStreamMain.println(string);
